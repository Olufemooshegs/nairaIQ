...
def do():
    ...
    r = conn.getresponse(); print('personal', r.status, r.read().decode())
    ...
    r = conn.getresponse(); print('financial', r.status, r.read().decode())
